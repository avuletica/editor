...
class TitleBar(QtWidgets.QDialog):
	...
	def mouseMoveEvent(self,event):
		if(cwindow.moving):
			cwindow.move(event.globalPos()-cwindow.offset) 
...
class Ui_MainWindow(QtWidgets.QMainWindow):
	...
	def setupUi(self, MainWindow):
		...
		font.setPointSize(9)
		self.lineTextEdit.setFont(font)
		...
		self.BuildTextEdit.setMaximumSize(QtCore.QSize(16777215, 200))
		font = QtGui.QFont()
		font.setFamily("Consolas")
		font.setPointSize(10)
		self.BuildTextEdit.setFont(font)
		...
		self.actionAbout.triggered.connect(cdialog_about.show)
	...
	def ShowBuild(self):
		...
		env = os.environ #object representing the string environment
		p = subprocess.Popen(["gcc" ,name,"-o",output],env=env,stdout=subprocess.PIPE, stderr=subprocess.PIPE, shell=True)
		stdout = []
		stderr = []
